...
export class FilmListService {
  private filmListStored:FilmItem[]=[     
    { id:1, img:"../../assets/images/locandina (1).jpg", name:"Avatar", durataMinuti:120, genere:"azione", desc:"A paraplegic Marine dispatched to the moon Pandora on a unique mission becomes torn between following his orders and protecting the world he feels is his home. ", favourited:false, show:true},
    ...
    { id:4, img:"../../assets/images/locandina (3).jpg", name:"Men in Black", durataMinuti:90, genere:"commedia",desc:"In popular culture and UFO conspiracy theories, men in black (MIB) are supposed men dressed in black suits who claim to be quasi-government agents who harass or threaten UFO witnesses to keep them quiet about what they have seen. ",favourited:false,show:true},
    { id:5, img:"../../assets/images/locandina.jpg", name:"Seven Sisters", durataMinuti:85, genere:"psicologico",desc:"The Seven Sisters are a series of chalk cliffs by the English Channel. They form part of the South Downs in East Sussex, between the towns of Seaford and Eastbourne in southern England. ", favourited:false,show:true},
